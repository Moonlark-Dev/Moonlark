...
def upgrade(name: str = "") -> None:
    ...
    op.create_table('nonebot_plugin_bag_bag',
    ...
    op.create_table('nonebot_plugin_bag_bagoverflow',
    sa.Column('id_', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.String(length=128), nullable=False),
    sa.Column('item_id', sa.String(length=64), nullable=False),
    sa.Column('count', sa.Integer(), nullable=False),
    ...
    op.create_table('nonebot_plugin_vote_choice',
    sa.Column('_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('belong', sa.Integer(), nullable=False),
    ...
    op.create_table('nonebot_plugin_vote_vote',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('nonebot_plugin_vote_votelog',
    sa.Column('_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('belong', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.String(length=128), nullable=False),
