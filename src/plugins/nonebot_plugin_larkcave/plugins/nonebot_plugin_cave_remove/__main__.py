...
async def _(
    comment_id: int, session: async_scoped_session, is_superuser: bool = is_user_superuser(), user_id: str = get_user_id()
) -> None:
    try:
...
async def _(cave_id: int, session: async_scoped_session, is_superuser: bool = is_user_superuser(), user_id: str = get_user_id()) -> None:
    try:
