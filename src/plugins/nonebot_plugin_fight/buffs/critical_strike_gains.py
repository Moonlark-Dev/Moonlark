...
class CriticalStrikeRateGain(Buff):
    ...
    async def setup(self) -> None:
        self.monomer.critical_strike = self.monomer.critical_strike[0] + self.value, self.monomer.critical_strike[1]
...
class CriticalStrikeHarmGain(Buff):
    ...
    async def setup(self) -> None:
        self.monomer.critical_strike = self.monomer.critical_strike[0], self.monomer.critical_strike[1] + self.value
